...
const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/admin/surveys", label: "Anketler", icon: FileText, section: "Anket", roles: ["ADMIN", "UNIT_MANAGER"] },
  { href: "/admin/survey-assignments", label: "Atamalar", icon: UserCheck, section: "Anket", roles: ["ADMIN"] },
  { href: "/admin/categories", label: "Kategori ve sorular", icon: FolderTree, section: "Anket", roles: ["ADMIN", "UNIT_MANAGER"] },
